...
function HomePage() {
  ...
  const fetchManga = async () => {
    axios.get("http://127.0.0.1:8000/api/manga/homePage").then((response) => {
  ...
  const initCarosel = async () => {
    axios.get("http://127.0.0.1:8000/api/manga/carousel").then((response) => {
  ...
  return (
    <div id="MainContent">
      <MainLayout>
        ...
        <Row>
          <Col className="" span={15} xs={24} xl={15}>
            <Row className="">
                    ...
                    renderItem={(manga) => (
                      <List.Item>
                        <Card
                          ...
                          hoverable
                          bordered={false}
                          style={{ backgroundColor: "#343a40", width: 140 }}
                          cover={
                            <img
                              width={130}
                              height={180}
