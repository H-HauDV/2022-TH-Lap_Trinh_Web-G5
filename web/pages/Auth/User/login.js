...
function UserLoginPage() {
  ...
  return (
    <div id="MainContent">
      <MainLayout >
      <Row className="login-section" style={{  backgroundColor: "#343a40", borderRadius: 5, marginTop:50, marginBottom: 50, padding: 20,}}>
        <Col span={24}>
            <Row>
              <Col span={24}>
            ...
            <Form name="basic" labelCol={{ span: 4 }} wrapperCol={{ span: 16 }} initialValues={{ remember: false }}
                ...
                <Form.Item className="text-white" name="remember" valuePropName="checked" wrapperCol={{ offset: 4, span: 16 }}>
